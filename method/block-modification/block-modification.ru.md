...
Модификатор `disabled` переводит блок `button`, открывающий всплывающее окно, в состояние «отключен».
...
![Disabled button](https://github.com/innabelaya/bem-docs/blob/master/pics/block-modification/button-disabled.png?raw=true)

> Подробнее о том, когда используется [булевый модификатор](../../faq/#Когда-создавать-булевый-модификатор-когда--модификатор-«ключ-значение»)
